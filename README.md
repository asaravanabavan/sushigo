...
Inside MyAgent.java:
private int numDeterminizations = 5; // raise to 7–9 for stronger+slow , 3 for faster+weaker

p.rolloutLength = 12; // try 8–12 if too slow
